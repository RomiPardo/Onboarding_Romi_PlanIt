...
const buttonStyles = cva("", {
  variants: {
    intent: {
      ...
      secondary:
        "box-border h-8 w-full rounded border-1 bg-wite text-center text-base font-medium leading-4 text-gray shadow-sm hover:cursor-pointer md:h-9 md:text-base md:font-medium",
