...
const inputStyles = cva("", {
  variants: {
    intent: {
      ...
      secondary:
        "focus:!important border-b bordr-l-0 border-r-0 border-t-0 border-solid border-gray pb-2  focus:outline-none ms:pb-3 text-gray leading-normal text-base font-medium",
    },
    defaultVariants: {
      intent: "primary",
    },
